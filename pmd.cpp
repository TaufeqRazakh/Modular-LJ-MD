...
SubSystem::SubSystem(int sid, array<int, 3> vproc, array<int, 3> InitUcell, double InitTemp, double Density): pid(0), n(0), nglob(0), comt(0.0), al{}, vid{}, myparity{}, nn{}, sv{}, vSum{}, gvSum{}, atoms{}, kinEnergy(0.0), potEnergy(0.0), totEnergy(0.0), temperature(0) {
...
void SubSystem::EvalProps(int stepCount, double DeltaT) {
  double vv=0,lke=0;
  int i,a;
